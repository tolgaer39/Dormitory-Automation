...
{
    public partial class FormYonetimSifreDegisim : Form
    {
        public FormYonetimSifreDegisim()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if (textBox1.Text != "" && textBox3.Text == textBox4.Text && textBox2.Text != "" && textBox3.Text != "")
            {
                ...
                OleDbCommand veri = new OleDbCommand("SELECT * FROM yonetici_girisi where (kullanici_ad='" + textBox1.Text + "' ) ", bagla);
                OleDbDataReader oku;
                bagla.Open();
                string srg1;
                ...
                if (oku.Read())
                {
                    ...
                    {
                        OleDbCommand yenile = new OleDbCommand("UPDATE yonetici_girisi SET kullanici_ad='" + textBox2.Text + "',kullanici_sifre='" + textBox3.Text + "' where kullanici_ad='"+textBox1.Text+"'", bagla);
